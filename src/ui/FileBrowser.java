...
public class FileBrowser extends List implements CommandListener {
    ...
    /**
     * Creates a new instance of FileBrowser for given <code>Main</code> object.
     * @param main non null Main object.
     */
    ...
    public void commandAction(Command command, Displayable displayable) {
        if (command == List.SELECT_COMMAND) {
            ...
            if (currFile.endsWith(String.valueOf(SEPERATOR)) || currFile.equals(UP_DIRECTORY)) {
                ...
                main.openRom(FILE_PROTOCOL + currDirName + currFile);
            }
        }
        else if (command == main.exitCommand) {
